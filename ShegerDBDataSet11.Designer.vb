...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("ShegerDBDataSet1"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class ShegerDBDataSet1
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As ShegerDBDataSet1 = CType(MyBase.Clone,ShegerDBDataSet1)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "ShegerDBDataSet1"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/ShegerDBDataSet11.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As ShegerDBDataSet1 = New ShegerDBDataSet1()
    ...
    Partial Public Class BookDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddBookRow(ByVal BookCode As String, ByVal Title As String, ByVal Author As String, ByVal No_of_Pages As String, ByVal Year_Published As String, ByVal Category As String, ByVal Shelf As String) As BookRow
            Dim rowBookRow As BookRow = CType(Me.NewRow,BookRow)
            Dim columnValuesArray() As Object = New Object() {BookCode, Title, Author, No_of_Pages, Year_Published, Category, Shelf}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Function FindByBookCode(ByVal BookCode As String) As BookRow
            Return CType(Me.Rows.Find(New Object() {BookCode}),BookRow)
        End Function
    ...
    Partial Public Class BookRow
        ...
        Public Property BookCode() As String
            Get
                Return CType(Me(Me.tableBook.BookCodeColumn),String)
            End Get
            Set
                Me(Me.tableBook.BookCodeColumn) = value
            End Set
        End Property
...
Namespace ShegerDBDataSet1TableAdapters
    ...
    Partial Public Class BookTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Book` WHERE ((`BookCode` = ?) AND ((? = 1 AND `Title` IS NULL) OR (`"& _ 
                "Title` = ?)) AND ((? = 1 AND `Author` IS NULL) OR (`Author` = ?)) AND ((? = 1 AN"& _ 
                "D `No of Pages` IS NULL) OR (`No of Pages` = ?)) AND ((? = 1 AND `Year Published"& _ 
                "` IS NULL) OR (`Year Published` = ?)) AND ((? = 1 AND `Category` IS NULL) OR (`C"& _ 
                "ategory` = ?)) AND ((? = 1 AND `Shelf` IS NULL) OR (`Shelf` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Book` (`BookCode`, `Title`, `Author`, `No of Pages`, `Year Published"& _ 
                "`, `Category`, `Shelf`) VALUES (?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Book` SET `BookCode` = ?, `Title` = ?, `Author` = ?, `No of Pages` = ?, `"& _ 
                "Year Published` = ?, `Category` = ?, `Shelf` = ? WHERE ((`BookCode` = ?) AND ((?"& _ 
                " = 1 AND `Title` IS NULL) OR (`Title` = ?)) AND ((? = 1 AND `Author` IS NULL) OR"& _ 
                " (`Author` = ?)) AND ((? = 1 AND `No of Pages` IS NULL) OR (`No of Pages` = ?)) "& _ 
                "AND ((? = 1 AND `Year Published` IS NULL) OR (`Year Published` = ?)) AND ((? = 1"& _ 
                " AND `Category` IS NULL) OR (`Category` = ?)) AND ((? = 1 AND `Shelf` IS NULL) O"& _ 
                "R (`Shelf` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT BookCode, Title, Author, [No of Pages], [Year Published], Category, Shelf "& _ 
                "FROM Book"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As ShegerDBDataSet1.BookDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As ShegerDBDataSet1.BookDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As ShegerDBDataSet1.BookDataTable = New ShegerDBDataSet1.BookDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As ShegerDBDataSet1.BookDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As ShegerDBDataSet1) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_BookCode As String, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_No_of_Pages As String, ByVal Original_Year_Published As String, ByVal Original_Category As String, ByVal Original_Shelf As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal BookCode As String, ByVal Title As String, ByVal Author As String, ByVal No_of_Pages As String, ByVal Year_Published As String, ByVal Category As String, ByVal Shelf As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal BookCode As String, ByVal Title As String, ByVal Author As String, ByVal No_of_Pages As String, ByVal Year_Published As String, ByVal Category As String, ByVal Shelf As String, ByVal Original_BookCode As String, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_No_of_Pages As String, ByVal Original_Year_Published As String, ByVal Original_Category As String, ByVal Original_Shelf As String) As Integer
            If (BookCode Is Nothing) Then
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_BookCode,String)
            End If
            If (Original_Title Is Nothing) Then
        ...
        Public Overloads Overridable Function Update(ByVal Title As String, ByVal Author As String, ByVal No_of_Pages As String, ByVal Year_Published As String, ByVal Category As String, ByVal Shelf As String, ByVal Original_BookCode As String, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_No_of_Pages As String, ByVal Original_Year_Published As String, ByVal Original_Category As String, ByVal Original_Shelf As String) As Integer
            Return Me.Update(Original_BookCode, Title, Author, No_of_Pages, Year_Published, Category, Shelf, Original_BookCode, Original_Title, Original_Author, Original_No_of_Pages, Original_Year_Published, Original_Category, Original_Shelf)
        End Function
    End Class
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As ShegerDBDataSet1, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As ShegerDBDataSet1, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._bookTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As ShegerDBDataSet1, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._bookTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As ShegerDBDataSet1) As Integer
